...
user_test = User(0, "Hash here for test", "Irfan", "Uludag", True)
user_update_test = User(3, "Updated hash test", "Irfan", "Uludag", False)
user_dao = UserDAOImp()
...
def test_dao_update_user():
    ...
    assert return_user.hashed_user == "Updated hash test"
